...
def get_config():
    ...
    parser.add_argument('--NUM_NEG', type=int, default=99) # number of negative samples for val&tst
    ...
    # privacy evaluate
    parser.add_argument('--pri_epoch', type=int, default=100)
    ...
    parser.add_argument('--pries_lr', type=float, default=0.01, help='lr of privacy estimator in client')
    ...
    parser.add_argument('--pretrain', type=boolean_string, default=False, help='pre-train the fedncf, keep all param in client')
    parser.add_argument('--finetune', type=boolean_string, default=True, help='fine tune the fedncf from data')
    parser.add_argument('--NAME', type=str, default='pretrain-apdf2', help='fine tune param')
